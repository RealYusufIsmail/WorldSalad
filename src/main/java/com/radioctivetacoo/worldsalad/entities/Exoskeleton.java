...
public class Exoskeleton extends MonsterEntity implements IAnimatedEntity {
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal<>(this, SoldierAnt.class, true));
