...
public class Bluecap extends CreatureEntity implements IAnimatedEntity {
	...
	public Bluecap(EntityType<? extends CreatureEntity> type, World worldIn) {
		super(type, worldIn);
	...
	protected void registerGoals() {
		this.goalSelector.addGoal(12, new LookAtGoal(this, Bluecap.class, 3.0F));
		...
		this.targetSelector.addGoal(8, (new HurtByTargetGoal(this, Bluecap.class).setCallsForHelp(Bluecap.class)));
	}
	...
	private <E extends Bluecap> boolean animationPredicate(AnimationTestEvent<E> event)
	{
		if(event.isWalking())
		{
