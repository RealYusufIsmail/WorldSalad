...
public class ExoskeletonModel extends AnimatedEntityModel<Exoskeleton> {
    ...
    public ExoskeletonModel()
    {
		...
		Body.setTextureOffset(0, 3).addBox(0.0F, -8.0F, -1.0F, 0.0F, 1.0F, 5.0F, 0.0F, false);
		...
		LeftAntenna.setTextureOffset(4, 4).addBox(0.0F, -2.7765F, -0.1022F, 0.0F, 3.0F, 1.0F, 0.0F, false);
		...
		RightAntenna.setTextureOffset(4, 4).addBox(0.0F, -2.7765F, -0.1022F, 0.0F, 3.0F, 1.0F, 0.0F, false);
