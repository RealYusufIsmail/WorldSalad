...
public class DeepFryerScreen extends ContainerScreen<DeepFryerContainer> {

	private static final ResourceLocation TEXTURE = new ResourceLocation(WorldSalad.MOD_ID,
			"textures/gui/deep_fryer_gui.png");

	public DeepFryerScreen(DeepFryerContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
		...
		// smelt progress
		this.blit(this.guiLeft + 100, this.guiTop + 35, 176, 0, this.container.getSmeltProgressionScaled(), 16);
		// energy bar
