...
public class ArchaeologyStationScreen extends ContainerScreen<ArchaeologyStationContainer> {

	private static final ResourceLocation TEXTURE = new ResourceLocation(WorldSalad.MOD_ID,
			"textures/gui/archaeology_station_gui.png");

	public ArchaeologyStationScreen(ArchaeologyStationContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
		...
		// smelt progress
		this.blit(this.guiLeft + 57, this.guiTop + 34, 176, 0, this.container.getSmeltProgressionScaled(), 17);
		// energy bar
