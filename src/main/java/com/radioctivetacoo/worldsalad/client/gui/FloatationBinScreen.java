...
public class FloatationBinScreen extends ContainerScreen<FloatationBinContainer> {

	private static final ResourceLocation TEXTURE = new ResourceLocation(WorldSalad.MOD_ID,
			"textures/gui/floatation_bin_gui.png");

	public FloatationBinScreen(FloatationBinContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
		...
		// smelt progress
		this.blit(this.guiLeft + 88, this.guiTop + 35, 176, 0, this.container.getSmeltProgressionScaled(), 16);
		// energy bar
