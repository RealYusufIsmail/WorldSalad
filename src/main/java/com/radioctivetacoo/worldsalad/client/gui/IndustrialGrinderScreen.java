...
public class IndustrialGrinderScreen extends ContainerScreen<IndustrialGrinderContainer> {

	private static final ResourceLocation TEXTURE = new ResourceLocation(WorldSalad.MOD_ID,
			"textures/gui/industrial_grinder_gui.png");

	public IndustrialGrinderScreen(IndustrialGrinderContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
		...
		// smelt progress
		this.blit(this.guiLeft + 65, this.guiTop + 35, 176, 0, this.container.getSmeltProgressionScaled(), 16);
		// energy bar
