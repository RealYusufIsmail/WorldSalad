...
public class DistillingBarrelScreen extends ContainerScreen<DistillingBarrelContainer> {

	private static final ResourceLocation TEXTURE = new ResourceLocation(WorldSalad.MOD_ID,
			"textures/gui/distilling_barrel_gui.png");

	public DistillingBarrelScreen(DistillingBarrelContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
		...
		// Water fluid bar
		if (this.container.tileEntity.hasWater()) {
			int i = this.container.getWaterAmountScaled();
			this.blit(this.guiLeft + 16, this.guiTop + 16 + 30 - i, 176, 107 - i, 16, 30);
		}
		// Output fluid bar
