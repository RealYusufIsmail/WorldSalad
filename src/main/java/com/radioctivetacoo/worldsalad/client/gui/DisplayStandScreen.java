...
public class DisplayStandScreen extends ContainerScreen<DisplayStandContainer> {

	private static final ResourceLocation TEXTURE = new ResourceLocation(WorldSalad.MOD_ID,
			"textures/gui/display_stand_gui.png");

	public DisplayStandScreen(DisplayStandContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
