...
public class DeepFryerContainer extends Container {

	public DeepFryerTileEntity tileEntity;
	...
	// Server Constructor
	public DeepFryerContainer(final int windowID, final PlayerInventory playerInv, final DeepFryerTileEntity tile) {
		super(ContainerInit.DEEP_FRYER.get(), windowID);
	...
	// Client Constructor
	public DeepFryerContainer(final int windowID, final PlayerInventory playerInv, final PacketBuffer data) {
		this(windowID, playerInv, getTileEntity(playerInv, data));
	}

	private static DeepFryerTileEntity getTileEntity(final PlayerInventory playerInv, final PacketBuffer data) {
		Objects.requireNonNull(playerInv, "playerInv cannot be null");
		Objects.requireNonNull(data, "data cannot be null");
		final TileEntity tileAtPos = playerInv.player.world.getTileEntity(data.readBlockPos());
		if (tileAtPos instanceof DeepFryerTileEntity) {
			return (DeepFryerTileEntity) tileAtPos;
		}
	...
	public boolean canInteractWith(PlayerEntity playerIn) {
		return isWithinUsableDistance(canInteractWithCallable, playerIn, BlockInit.DEEP_FRYER.get());
	}
