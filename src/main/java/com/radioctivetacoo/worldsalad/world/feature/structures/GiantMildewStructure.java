...
public class GiantMildewStructure extends Structure<NoFeatureConfig> {

	public GiantMildewStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn) {
	...
	public IStartFactory getStartFactory() {
		return GiantMildewStructure.Start::new;
	}

	@Override
	public String getStructureName() {
		return WorldSalad.MOD_ID + ":giant_mildew";
	}
	...
	public static class Start extends StructureStart {
		...
		public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ,
			...
			GiantMildewPieces.Start(templateManagerIn, pos, rotation, this.components, this.rand);
