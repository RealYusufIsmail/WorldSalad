...
public class OilWellStructure extends Structure<NoFeatureConfig> {

	public OilWellStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn) {
	...
	public IStartFactory getStartFactory() {
		return OilWellStructure.Start::new;
	}

	@Override
	public String getStructureName() {
		return WorldSalad.MOD_ID + ":oil_well";
	}
	...
	public static class Start extends StructureStart {
		...
		public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ,
			...
			OilWellPieces.Start(templateManagerIn, pos, rotation, this.components, this.rand);
