...
public class NetherShrineStructure extends Structure<NoFeatureConfig> {

	public NetherShrineStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn) {
	...
	public String getStructureName() {
		return WorldSalad.MOD_ID + ":nether_shrine";
	}
	...
	public static class Start extends StructureStart {
		...
		public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ,
			...
			NetherShrinePieces.Start(templateManagerIn, pos, rotation, this.components, this.rand);
