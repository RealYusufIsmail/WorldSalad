...
public class ShroomHouseStructure extends Structure<NoFeatureConfig> {

	public ShroomHouseStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn) {
	...
	public IStartFactory getStartFactory() {
		return ShroomHouseStructure.Start::new;
	}

	@Override
	public String getStructureName() {
		return WorldSalad.MOD_ID + ":shroomhouse";
	}
	...
	public static class Start extends StructureStart {
		...
		public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ,
			...
			ShroomHousePieces.Start(templateManagerIn, pos, rotation, this.components, this.rand);
