...
public class MushrockThreeStructure extends Structure<NoFeatureConfig> {

	public MushrockThreeStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn) {
	...
	public IStartFactory getStartFactory() {
		return MushrockThreeStructure.Start::new;
	}

	@Override
	public String getStructureName() {
		return WorldSalad.MOD_ID + ":mushrock3";
	}
	...
	public static class Start extends StructureStart {
		...
		public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ,
			...
			MushrockThreePieces.Start(templateManagerIn, pos, rotation, this.components, this.rand);
