...
public class ShroomHousePieces {

	private static final ResourceLocation PART_1 = new ResourceLocation(WorldSalad.MOD_ID, "shroomhouse");
	...
	public static void Start(TemplateManager manager, BlockPos pos, Rotation rot, List<StructurePiece> pieces, Random rand)
	{
		...
		BlockPos rotationOffset = new BlockPos(0, -8, 0).rotate(rot);
		BlockPos blockpos =  rotationOffset.add(x, pos.getY(), z);
		pieces.add(new ShroomHousePieces.Piece(manager, PART_1, blockpos, rot));
	}
	...
	public static class Piece extends TemplateStructurePiece {
		...
		public Piece(TemplateManager templateManagerIn, ResourceLocation resourceLocationIn, BlockPos pos,
				Rotation rotationIn) {
			super(FeatureInit.SHROOMHOUSE_PIECE, 0);
			this.resourceLocation = resourceLocationIn;
			BlockPos blockpos = ShroomHousePieces.OFFSET.get(resourceLocation);
		...
		public Piece(TemplateManager templateManagerIn, CompoundNBT tagCompound) {
			super(FeatureInit.SHROOMHOUSE_PIECE, tagCompound);
		...
		protected void handleDataMarker(String function, BlockPos pos, IWorld worldIn, Random rand, MutableBoundingBox sbb) {
			...
			if ("chest".equals(function)) {
				...
				worldIn.setBlockState(pos, StructurePiece.correctFacing(worldIn, pos, Blocks.CHEST.getDefaultState()), 2);
				TileEntity tileentity = worldIn.getTileEntity(pos);
				if (tileentity instanceof ChestTileEntity) {
					System.out.print("there's a tileentity at "  + pos);
					((ChestTileEntity) tileentity).setLootTable(new ResourceLocation(WorldSalad.MOD_ID, ":chests/hyphae_tier_1"), 67483211);
				}
			}
		}
		...
		public boolean create(IWorld worldIn, ChunkGenerator<?> generator, Random randomIn,
			...
			PlacementSettings placementsettings = (new PlacementSettings()).setRotation(this.rotation)
					.setMirror(Mirror.NONE);
			BlockPos blockpos = ShroomHousePieces.OFFSET.get(this.resourceLocation);
