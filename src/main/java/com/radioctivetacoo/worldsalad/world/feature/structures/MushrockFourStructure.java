...
public class MushrockFourStructure extends Structure<NoFeatureConfig> {

	public MushrockFourStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn) {
	...
	public IStartFactory getStartFactory() {
		return MushrockFourStructure.Start::new;
	}

	@Override
	public String getStructureName() {
		return WorldSalad.MOD_ID + ":mushrock4";
	}
	...
	public static class Start extends StructureStart {
		...
		public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ,
			...
			MushrockFourPieces.Start(templateManagerIn, pos, rotation, this.components, this.rand);
