...
public class MushrockSixStructure extends Structure<NoFeatureConfig> {

	public MushrockSixStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn) {
	...
	public IStartFactory getStartFactory() {
		return MushrockSixStructure.Start::new;
	}

	@Override
	public String getStructureName() {
		return WorldSalad.MOD_ID + ":mushrock6";
	}
	...
	public static class Start extends StructureStart {
		...
		public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ,
			...
			MushrockSixPieces.Start(templateManagerIn, pos, rotation, this.components, this.rand);
