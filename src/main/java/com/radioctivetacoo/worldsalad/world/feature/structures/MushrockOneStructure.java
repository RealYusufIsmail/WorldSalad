...
public class MushrockOneStructure extends Structure<NoFeatureConfig> {

	public MushrockOneStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn) {
	...
	public IStartFactory getStartFactory() {
		return MushrockOneStructure.Start::new;
	}

	@Override
	public String getStructureName() {
		return WorldSalad.MOD_ID + ":mushrock1";
	}
	...
	public static class Start extends StructureStart {
		...
		public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ,
			...
			MushrockOnePieces.Start(templateManagerIn, pos, rotation, this.components, this.rand);
