...
public class AntHiveStructure extends Structure<NoFeatureConfig> {

	public AntHiveStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn) {
	...
	public IStartFactory getStartFactory() {
		return AntHiveStructure.Start::new;
	}

	@Override
	public String getStructureName() {
		return WorldSalad.MOD_ID + ":ant_hive";
	}
	...
	public static class Start extends StructureStart {
		...
		public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ,
			...
			AntHivePieces.Start(templateManagerIn, pos, rotation, this.components, this.rand);
