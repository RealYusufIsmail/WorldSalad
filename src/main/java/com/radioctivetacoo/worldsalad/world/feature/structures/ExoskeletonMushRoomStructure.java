...
public class ExoskeletonMushRoomStructure extends Structure<NoFeatureConfig> {

	public ExoskeletonMushRoomStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn) {
	...
	public IStartFactory getStartFactory() {
		return ExoskeletonMushRoomStructure.Start::new;
	}

	@Override
	public String getStructureName() {
		return WorldSalad.MOD_ID + ":exoskeleton_mush_room";
	}
	...
	public static class Start extends StructureStart {
		...
		public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ,
			...
			ExoskeletonMushRoomPieces.Start(templateManagerIn, pos, rotation, this.components, this.rand);
