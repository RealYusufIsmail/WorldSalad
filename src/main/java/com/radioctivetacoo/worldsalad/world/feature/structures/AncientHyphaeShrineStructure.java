...
public class AncientHyphaeShrineStructure extends Structure<NoFeatureConfig> {

	public AncientHyphaeShrineStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn) {
	...
	public IStartFactory getStartFactory() {
		return AncientHyphaeShrineStructure.Start::new;
	}

	@Override
	public String getStructureName() {
		return WorldSalad.MOD_ID + ":ancient_hyphae_shrine";
	}
	...
	public static class Start extends StructureStart {
		...
		public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ,
			...
			AncientHyphaeShrinePieces.Start(templateManagerIn, pos, rotation, this.components, this.rand);
