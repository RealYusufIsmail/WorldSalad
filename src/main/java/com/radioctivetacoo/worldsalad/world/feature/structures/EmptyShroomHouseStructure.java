...
public class EmptyShroomHouseStructure extends Structure<NoFeatureConfig> {

	public EmptyShroomHouseStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn) {
	...
	public IStartFactory getStartFactory() {
		return EmptyShroomHouseStructure.Start::new;
	}

	@Override
	public String getStructureName() {
		return WorldSalad.MOD_ID + ":empty_shroomhouse";
	}
	...
	public static class Start extends StructureStart {
		...
		public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ,
			...
			EmptyShroomHousePieces.Start(templateManagerIn, pos, rotation, this.components, this.rand);
