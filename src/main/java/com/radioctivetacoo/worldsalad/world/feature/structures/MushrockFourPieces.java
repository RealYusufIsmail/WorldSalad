...
public class MushrockFourPieces {

	private static final ResourceLocation PART_1 = new ResourceLocation(WorldSalad.MOD_ID, "mushrock4");
	...
	public static void Start(TemplateManager manager, BlockPos pos, Rotation rot, List<StructurePiece> pieces, Random rand)
	{
		...
		pieces.add(new MushrockFourPieces.Piece(manager, PART_1, blockpos, rot));
	}
	...
	public static class Piece extends TemplateStructurePiece {
		...
		public Piece(TemplateManager templateManagerIn, ResourceLocation resourceLocationIn, BlockPos pos,
				Rotation rotationIn) {
			super(FeatureInit.MUSHROCK4_PIECE, 0);
			this.resourceLocation = resourceLocationIn;
			BlockPos blockpos = MushrockFourPieces.OFFSET.get(resourceLocation);
		...
		public Piece(TemplateManager templateManagerIn, CompoundNBT tagCompound) {
			super(FeatureInit.MUSHROCK4_PIECE, tagCompound);
		...
		public boolean create(IWorld worldIn, ChunkGenerator<?> generator, Random randomIn,
			...
			PlacementSettings placementsettings = (new PlacementSettings()).setRotation(this.rotation)
					.setMirror(Mirror.NONE);
			BlockPos blockpos = MushrockFourPieces.OFFSET.get(this.resourceLocation);
