...
public class WraithMushRoomStructure extends Structure<NoFeatureConfig> {

	public WraithMushRoomStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn) {
	...
	public IStartFactory getStartFactory() {
		return WraithMushRoomStructure.Start::new;
	}

	@Override
	public String getStructureName() {
		return WorldSalad.MOD_ID + ":wraith_mush_room";
	}
	...
	public static class Start extends StructureStart {
		...
		public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ,
			...
			WraithMushRoomPieces.Start(templateManagerIn, pos, rotation, this.components, this.rand);
