...
public class MushrockFiveStructure extends Structure<NoFeatureConfig> {

	public MushrockFiveStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn) {
	...
	public IStartFactory getStartFactory() {
		return MushrockFiveStructure.Start::new;
	}

	@Override
	public String getStructureName() {
		return WorldSalad.MOD_ID + ":mushrock5";
	}
	...
	public static class Start extends StructureStart {
		...
		public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ,
			...
			MushrockFivePieces.Start(templateManagerIn, pos, rotation, this.components, this.rand);
