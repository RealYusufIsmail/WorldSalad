...
public class VoronoiGenerator {
	...
	private static final int Y_NOISE_GEN = 0;
	...
	public static double getDValueNoise3D(int x, int y, int z, int seed) {
		return 1.0 - (getIValueNoise3D(x, y, z, seed) / 1073741824.0);
	}

	public static int getIValueNoise3D(int x, int y, int z, int seed) {
		int n = (X_NOISE_GEN * x + Y_NOISE_GEN * y + Z_NOISE_GEN * (z * 2) + SEED_NOISE_GEN * seed) & 0x7fffffff;
		n = (n >> 13) ^ n;
