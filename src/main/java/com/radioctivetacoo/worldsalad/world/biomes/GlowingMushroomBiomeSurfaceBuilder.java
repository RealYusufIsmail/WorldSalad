...
public class GlowingMushroomBiomeSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderConfig> {
	   public GlowingMushroomBiomeSurfaceBuilder(Function<Dynamic<?>, ? extends SurfaceBuilderConfig> p_i51304_1_) {
	      super(p_i51304_1_);
	   }
