...
public class MushroomCanyonBiomeSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderConfig> {
	private static final BlockState WHITE_TERRACOTTA = BlockInit.CLAYSTONE.get().getDefaultState();
	private static final BlockState ORANGE_TERRACOTTA = BlockInit.CLAYSTONE.get().getDefaultState();
	private static final BlockState TERRACOTTA = BlockInit.RED_CLAYSTONE.get().getDefaultState();
	private static final BlockState YELLOW_TERRACOTTA = BlockInit.PURPLE_CLAYSTONE.get().getDefaultState();
	private static final BlockState BROWN_TERRACOTTA = BlockInit.GREEN_CLAYSTONE.get().getDefaultState();
	private static final BlockState RED_TERRACOTTA = BlockInit.RED_CLAYSTONE.get().getDefaultState();
	private static final BlockState LIGHT_GRAY_TERRACOTTA = BlockInit.WHITE_CLAYSTONE.get().getDefaultState();
	...
	public MushroomCanyonBiomeSurfaceBuilder(Function<Dynamic<?>, ? extends SurfaceBuilderConfig> func) {
		super(func);
	}
