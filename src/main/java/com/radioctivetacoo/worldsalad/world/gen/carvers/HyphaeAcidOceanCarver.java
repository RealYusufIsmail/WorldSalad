...
public class HyphaeAcidOceanCarver extends CaveWorldCarver {
	public HyphaeAcidOceanCarver(Function<Dynamic<?>, ? extends ProbabilityConfig> p_i49929_1_) {
		super(p_i49929_1_, 30);
		this.carvableBlocks = ImmutableSet.of(BlockInit.TOUGH_HYPHAE.get(), BlockInit.FUNGAL_DIRT.get(),
				BlockInit.GLOWING_HYCELIUM.get(), BlockInit.MUD.get(), BlockInit.GLOWING_CORAL.get());
	}
