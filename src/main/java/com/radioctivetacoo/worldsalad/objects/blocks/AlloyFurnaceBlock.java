...
public class AlloyFurnaceBlock extends Block {
	...
	private static final VoxelShape SHAPE_N = Stream.of(
			Block.makeCuboidShape(1, 10, 2, 6, 11, 4),
			Block.makeCuboidShape(1, 10, 5, 11, 11, 7),
			Block.makeCuboidShape(1, 10, 8, 11, 11, 10),
			Block.makeCuboidShape(1, 10, 11, 5, 16, 15),
			Block.makeCuboidShape(6, 10, 1, 10, 13, 15),
			Block.makeCuboidShape(11, 10, 1, 15, 13, 15),
			Block.makeCuboidShape(0, 0, 0, 16, 10, 16)
			).reduce((v1, v2) -> {return VoxelShapes.combineAndSimplify(v1, v2, IBooleanFunction.OR);}).get();
	
	private static final VoxelShape SHAPE_W = Stream.of(
			Block.makeCuboidShape(2, 10, 10, 4, 11, 15),
			Block.makeCuboidShape(5, 10, 5, 7, 11, 15),
			Block.makeCuboidShape(8, 10, 5, 10, 11, 15),
			Block.makeCuboidShape(11, 10, 11, 15, 16, 15),
			Block.makeCuboidShape(1, 10, 6, 15, 13, 10),
			Block.makeCuboidShape(1, 10, 1, 15, 13, 5),
			Block.makeCuboidShape(0, 0, 0, 16, 10, 16)
			).reduce((v1, v2) -> {return VoxelShapes.combineAndSimplify(v1, v2, IBooleanFunction.OR);}).get();
	
	private static final VoxelShape SHAPE_E = Stream.of(
			Block.makeCuboidShape(12, 10, 1, 14, 11, 6),
			Block.makeCuboidShape(9, 10, 1, 11, 11, 11),
			Block.makeCuboidShape(6, 10, 1, 8, 11, 11),
			Block.makeCuboidShape(1, 10, 1, 5, 16, 5),
			Block.makeCuboidShape(1, 10, 6, 15, 13, 10),
			Block.makeCuboidShape(1, 10, 11, 15, 13, 15),
			Block.makeCuboidShape(0, 0, 0, 16, 10, 16)
			).reduce((v1, v2) -> {return VoxelShapes.combineAndSimplify(v1, v2, IBooleanFunction.OR);}).get();
	
	private static final VoxelShape SHAPE_S = Stream.of(
			Block.makeCuboidShape(10, 10, 12, 15, 11, 14),
			Block.makeCuboidShape(5, 10, 9, 15, 11, 11),
			Block.makeCuboidShape(5, 10, 6, 15, 11, 8),
			Block.makeCuboidShape(11, 10, 1, 15, 16, 5),
			Block.makeCuboidShape(6, 10, 1, 10, 13, 15),
			Block.makeCuboidShape(1, 10, 1, 5, 13, 15),
			Block.makeCuboidShape(0, 0, 0, 16, 10, 16)
			).reduce((v1, v2) -> {return VoxelShapes.combineAndSimplify(v1, v2, IBooleanFunction.OR);}).get();
