...
public class IndustrialGrinderRecipe implements IIndustrialGrinderRecipe {
	...
	public IndustrialGrinderRecipe(ResourceLocation id, Ingredient input, ItemStack output, ItemStack outputBonus) {
		this.outputBonus = outputBonus;
		this.id = id;
		this.output = output;
		this.input = input;
	}
	...
	@Override
	public ItemStack getOutputBonus() {
	...
	public IRecipeSerializer<?> getSerializer() {
		return RecipeSerializerInit.INDUSTRIAL_GRINDER_SERIALIZER.get();
	}
