...
public class KilnRecipeSerializer extends ForgeRegistryEntry<IRecipeSerializer<?>>
		implements IRecipeSerializer<KilnRecipe> {
	...
	public KilnRecipe read(ResourceLocation recipeId, JsonObject json) {
		...
		return new KilnRecipe(recipeId, input, output);
	}

	@Override
	public KilnRecipe read(ResourceLocation recipeId, PacketBuffer buffer) {
