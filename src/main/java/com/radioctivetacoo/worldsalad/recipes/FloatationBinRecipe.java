...
public class FloatationBinRecipe implements IFloatationBinRecipe {

	private final ResourceLocation id;
	private final Ingredient input;
	private final ItemStack output;

	public FloatationBinRecipe(ResourceLocation id, Ingredient input, ItemStack output) {
		this.id = id;
		this.output = output;
		this.input = input;
	}
	...
	public IRecipeSerializer<?> getSerializer() {
		return RecipeSerializerInit.FLOATATION_BIN_SERIALIZER.get();
	}
