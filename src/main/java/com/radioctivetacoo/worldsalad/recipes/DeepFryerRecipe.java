...
public class DeepFryerRecipe implements IDeepFryerRecipe {

	private final ResourceLocation id;
	private final Ingredient input;
	private final ItemStack output;

	public DeepFryerRecipe(ResourceLocation id, Ingredient input, ItemStack output) {
		this.id = id;
		this.output = output;
		this.input = input;
	}
	...
	public IRecipeSerializer<?> getSerializer() {
		return RecipeSerializerInit.DEEP_FRYER_SERIALIZER.get();
	}
